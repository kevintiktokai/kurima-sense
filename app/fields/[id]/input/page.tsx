...
import { InputLogForm } from '@/components/capture/InputLogForm'
        ...
        <PageContainer className="px-4 py-6 space-y-6">
            ...
            <header className="space-y-1">
                ...
                <p className="text-sm" style={{ color: 'var(--ee-muted)' }}>
                    {fieldLabel} — fertilizer, chemical, or seed. Works offline; speak or type.
                </p>
            </header>
            <InputLogForm fieldId={fieldId} fieldLabel={fieldLabel} />
        </PageContainer>
    )
}

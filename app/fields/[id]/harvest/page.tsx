...
import { HarvestForm } from '@/components/capture/HarvestForm'

export default function HarvestCapturePage() {
        ...
        <PageContainer className="px-4 py-6 space-y-6">
            ...
            <header className="space-y-1">
                ...
                <p className="text-sm" style={{ color: 'var(--ee-muted)' }}>
                    {fieldLabel} — works offline; entries upload automatically when you reconnect.
                </p>
            </header>

            <HarvestForm fieldId={fieldId} fieldLabel={fieldLabel} />
        </PageContainer>
    )
}

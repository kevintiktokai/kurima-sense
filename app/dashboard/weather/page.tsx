...
export default function WeatherPage() {
    ...
    const loadClimateData = async () => {
        ...
        try {
            ...
            const [currentData, forecastData, alertsData, agriData, sprayData, histData] = await Promise.all([
            ...
            console.error("Error loading climate data:", e);
        } finally {
            setLoading(false);
        }
    };
